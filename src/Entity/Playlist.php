...
class Playlist
{
    ...
    public function getMovies()
    {
        ...
        foreach ($this->playlistMedia as $playlistMedia) {
            if ($playlistMedia->getMedia() instanceof Movie) {
                $results[] = $playlistMedia->getMedia();
            }
        }
    ...
    public function getSeries()
    {
        ...
        foreach ($this->playlistMedia as $playlistMedia) {
            if ($playlistMedia->getMedia() instanceof Serie) {
                $results[] = $playlistMedia->getMedia();
            }
        }
    ...
    public function getMedias()
    {
        ...
        foreach ($this->playlistMedia as $playlistMedia) {
            if ($playlistMedia->getMedia() instanceof Media) {
                $results[] = $playlistMedia->getMedia();
            }
        }
